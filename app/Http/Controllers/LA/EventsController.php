...
class EventsController extends Controller
{
	...
	public $listing_cols = ['id', 'provider', 'category_id', 'title', 'slug', 'datetime_from', 'datetime_to', 'content', 'image', 'organiser', 'address', 'lng', 'lat', 'min_price', 'max_price', 'website', 'original_href', 'original_id', 'price', 'town', 'translation', 'lang', 'status'];
