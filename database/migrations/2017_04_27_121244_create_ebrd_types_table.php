...
class CreateEbrdTypesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Ebrd_types", 'ebrd_types', 'title', 'fa-align-left', [
    ...
    {
        if (Schema::hasTable('ebrd_types')) {
            Schema::drop('ebrd_types');
        }
    }
}
