...
class CreateSightseeingsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Sightseeings", 'sightseeings', 'title', 'fa-align-left', [
            ...
            ["translation", "translation of", "Dropdown", false, "", 0, 0, false, "@sightseeings"],
        ]);
    ...
    {
        if (Schema::hasTable('sightseeings')) {
