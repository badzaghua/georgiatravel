...
class CreateUserSavesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("User_saves", 'user_saves', 'title', 'fa-align-left', [
            ...
            ["object", "object_id", "Address", false, "", 0, 256, false],
            ["object_id", "object id", "Integer", false, "", 0, 11, false],
        ]);
