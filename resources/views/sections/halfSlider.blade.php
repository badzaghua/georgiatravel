<!-- Full Page Image Background Carousel Header -->
    <header id="myCarousel" class="carousel slide half-carousel" data-rider="carousel">
        <!-- Indicators -->
...
@if(isset($slider) && $slider->count())         
        @foreach($slider as $slide)
            <div class="item {{ !isset($mainSliderStarted) ? 'active' : '' }}">
                ...
                <div class="fill" style="background-image:url('{{ Imagepath($slide->image) }}/w=1800&h=400');"></div>
...
<div class="item active">
                <div class="fill" style="background-image:url('{{ Imagepath($sliderImage) }}/w=1800&h=400');"></div>
                <div class="carousel-caption">
