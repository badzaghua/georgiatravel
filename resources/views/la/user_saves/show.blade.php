...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $user_safe->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("User_saves", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/user_saves/'.$user_safe->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("User_saves", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.user_saves.destroy', $user_safe->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/user_saves') }}" data-toggle="tooltip" data-placement="right" title="Back to User saves"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'href')
						@la_display($module, 'object')
						@la_display($module, 'object_id')
					</div>
				</div>
			</div>
		</div>
