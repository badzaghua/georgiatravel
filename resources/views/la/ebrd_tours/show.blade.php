...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $ebrd_tour->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Ebrd_tours", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/ebrd_tours/'.$ebrd_tour->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Ebrd_tours", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.ebrd_tours.destroy', $ebrd_tour->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/ebrd_tours') }}" data-toggle="tooltip" data-placement="right" title="Back to Ebrd tours"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'types')
						@la_display($module, 'duration')
						@la_display($module, 'languages')
						@la_display($module, 'locations')
						@la_display($module, 'agency')
					</div>
				</div>
			</div>
		</div>
