			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'datetime_from')
						@la_display($module, 'datetime_to')
						@la_display($module, 'content')
						@la_display($module, 'image')
						@la_display($module, 'organiser')
						@la_display($module, 'address')
						@la_display($module, 'lng')
						@la_display($module, 'lat')
						@la_display($module, 'min_price')
						@la_display($module, 'max_price')
						@la_display($module, 'website')
						@la_display($module, 'original_href')
						@la_display($module, 'original_id')
